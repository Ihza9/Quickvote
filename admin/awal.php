...
?>
            ...
            <a href="?m=kelas" class="small-box-footer">Info Pengguna <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
?>
            ...
            <a href="?m=siswa" class="small-box-footer">Info Pengguna Aktif <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
?>
            ...
            <a href="?m=kandidat" class="small-box-footer">Info Kandidat <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
